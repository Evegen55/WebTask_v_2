...
public class AllAccounts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<BankAccount> list = clientDAO.getAllAccountsByClientID(client.getClientID());
        request.setAttribute("allaccounts", list);
        request.getRequestDispatcher("/simple_user_pages/allaccounts.jsp").forward(request, response);
    }
